...
trlコミュニティが早速[GRPO](https://github.com/trl-community/trl/blob/main/examples/rlhf/grpo/grpo_trainer.py)の実装を公開したので、早速試してみたいと思います。
...
LoRAを用いた学習を行いましたが、報酬は微増したものの、絵文字生成されなかった。
